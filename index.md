...
## News 1/10/17: WHOOPS, my computer won't boot!
As some of you have noted, I haven't commited anything for a good month now, with alot more features to be implemented, well thats my mistake. First it started with the Winter Crew Training starting at my school, giving me no time to work, then it escalated when the holidays began, and it finally kicked the lid off when I installed my CPU incorrectly and bent the pins. I hope to have a fix for that problem between Feb. - March but no promises, for now not much will be done, as my compiling computer broke and I don't want to wait an hour to test the script on two architectures everytime I make a commit. A solution to this problem could be setting up my server as an auto-builder, as some online services do, but that's too much work and times an issue. So hopefully that will be fixed soon.
